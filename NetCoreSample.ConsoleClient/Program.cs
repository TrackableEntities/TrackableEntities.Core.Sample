...
using NetCoreSample.Entities.Client;
using TrackableEntities.Client;

namespace NetCoreSample.ConsoleClient
{
    class Program
    {
        ...
        private static void GetFormatter(out MediaTypeFormatter formatter, out string acceptHeader)
        {
